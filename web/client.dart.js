...
$$.Object = {"": ";",
  ...
  toLocal$0: function() {
    return this.noSuchMethod$1(this, $.createInvocationMirror("toLocal", "toLocal$0", 0, [], []));
  },
...
$$.Callback = {"": "Object;",
  ...
  Callback$many$1: function(f) {
    this._liblib3$_callback = new $.anon0(f);
...
$$._ProxiedObjectTable = {"": "Object;_name,_nextId,_deletedCount,_registry>,_port,_globalIds,_handleStack,_scopeIndices>",
  enterScope$0: function() {
    $.CONSTANT.add$1(this._scopeIndices, this._handleStack.length);
  },
  exitScope$0: function() {
  ...
  add$1: function(_, x) {
    ...
    t3 = this._registry;
    t3.$indexSet(t3, id, x);
    $.CONSTANT.add$1(this._handleStack, id);
    return id;
  },
  get$1: function(id) {
...
$$.loadMap_anon = {"": "Closure;vTitle_0,vDescription_1,vPhoto_2,vUserTime_3,MarkerImage_4",
  call$0: function() {
    var t1, t2, mapOptions, makerShape, markerIcon, $content, t3, t4, t5, marker1, infoWindow;
    ...
    $content.set$innerHtml("    <h3><b>" + $.S(this.vTitle_0) + "</b></h3>\n    <p>" + $.S(this.vDescription_1) + "</p>\n    <p>" + $.S(this.vPhoto_2) + "</p>\n    <b>" + $.S(this.vUserTime_3) + "</b>\n    ");
    ...
    t5.set$content($content);
    infoWindow = $.InfoWindow$(t5);
    t5 = "Date Time: " + $.S($.get$usrTime());
    document.query$1("#time").set$text(t5);
    t5 = marker1.get$on().get$mouseover();
    t5.add$1(t5, new $.loadMap__anon(marker1, infoWindow));
    $.CONSTANT.forEach$1([$.map, marker1, makerShape, infoWindow], $.retain);
  }
};

$$.loadMap__anon = {"": "Closure;marker1_5,infoWindow_6",
  call$1: function(e) {
    this.infoWindow_6.open$2($.map, this.marker1_5);
  }
};
...
$.complete = function() {
  $.Primitives_printString("Complete:" + $.S($.title) + "," + $.S($.description) + "," + $.S($.photo) + "," + $.S($.time) + "," + $.S($.ip));
};
...
$.processString = function(jsonString) {
  ...
  $.Primitives_printString($.S($.title) + "," + $.S($.description) + "," + $.S($.photo) + "," + $.S($.time) + "," + $.S($.ip));
};
...
$.ajaxGetJSON = function() {
  $.HttpRequest_getString("127.0.0.1:3030/news", null, null).then$1($.onDataLoaded);
};
...
$.onDataLoaded = function(responseText) {
  ...
  $.time = t1.$index(firstNews, "time");
  $.ip = t1.$index(firstNews, "ip");
  $.Primitives_printString("transfommer");
};
...
$.LatLng$ = function(lat, lng, noWrap) {
  ...
  t2 = $.CONSTANT.map$1([lat, lng, noWrap], $._serialize0);
  t2 = t2.toList$0(t2);
...
$.GMap_isInstance = function(jsProxy) {
  ...
  t3 = $.CONSTANT.map$1([jsProxy, t1], $._serialize);
...
$.GMap$ = function(mapDiv, opts) {
  var t1, t2;
  t1 = $.get$maps().get$Map();
  t2 = $.CONSTANT.map$1([mapDiv, opts], $._serialize0);
  t2 = t2.toList$0(t2);
...
$.InfoWindow$ = function(opts) {
  ...
  t2 = $.CONSTANT.map$1([opts], $._serialize0);
  t2 = t2.toList$0(t2);
...
$.Proxy_Proxy$withArgList = function($constructor, $arguments) {
  ...
  t1 = [$constructor];
  $.CONSTANT.addAll$1(t1, $arguments);
  t1 = $.CONSTANT.map$1(t1, $._serialize);
...
$.ajaxGetJSON.call$0 = $.ajaxGetJSON;
$.ajaxGetJSON.$name = "ajaxGetJSON";
...
Isolate.$lazy($, "usrTime", "usrTime", "get$usrTime", function() {
  return $.toString$0$abfnosu($.DateTime_DateTime$now().toLocal$0());
});
